    ...
    <div className="team-card">
      <div className="img-hover team-img-container">
        ...
        <div className="social-icons-container px-2 d-flex flex-column ">
          <a href="#"><FontAwesomeIcon icon={faFacebook} className="social-icons text-light my-2"/></a>
          <a href="#"><FontAwesomeIcon icon={faTwitter} className="social-icons text-light my-2"/></a>
          <a href="#"><FontAwesomeIcon icon={faLinkedinIn} className="social-icons text-light my-2"/></a>
          <a href="#"><FontAwesomeIcon icon={faYoutube} className="social-icons text-light my-2"/></a>
        </div>
      </div>
      <div className="team-discription mt-3">
        <p className="my-0 team-role">{ role }</p>
        <a href="#" className="team-link my-0"><h3 className="my-0">{ name }</h3></a>
      </div>
    </div>
  )
}
